export const TermsConditions = () => {
  ...
  return (
    <>
      ...
      <title>Privacy of your data</title>
      ...
      <div className="WordSection1">
        ...
        <p className="MsoNormal">
          <span
            style={{ fontFamily: '"-webkit-standard", serif', color: "white" }}
          >
            &nbsp;
          </span>
        </p>
        ...
        <p className="MsoNormal" style={{ lineHeight: "13.8pt" }}>
          <span
            style={{ fontFamily: '"-webkit-standard", serif', color: "white" }}
          >
            &nbsp;
        ...
        <p className="MsoNormal">
          ...
          >
            n app developed by Pop Lorenzo.
          </span>
        </p>
        <p className="MsoNormal" style={{ textAlign: "center" }}>
          <span
        ...
        <p className="MsoNormal">
          ...
          >
            We operate&nbsp;the mobile application&nbsp;Seen&nbsp;(the&nbsp;"
          </span>
          <b>
            <span
              style={{
        ...
        <p className="MsoNormal">
          ...
          >
            We provide a iOS application to allow users to share moments and
            store them. The user facilitates the going out's of people.
          </span>
        </p>
        <p className="MsoNormal">
          <span
        ...
        <p className="MsoNormal">
          ...
          >
            "), and&nbsp;Seen, concerning your access to and use of the
        ...
        <p className="MsoNormal">
          ...
          >
            ...
            effective&nbsp;thirty (30)&nbsp;days after the notice is given,
            except if the changes apply to&nbsp;new functionality,&nbsp;security
            updates,&nbsp;bug fixes, and&nbsp;a court order, in which case the
            changes will be effective immediately. By continuing to use the
          ...
          <a href="http://127.0.0.1:5500/Website/policy.html#terms">
            <span
              style={{
                fontSize: "11pt",
                fontFamily: '"Arial", sans-serif',
        ...
        <p className="MsoNormal">
          <a href="http://127.0.0.1:5500/Website/policy.html#services">
            <span
              style={{
                fontSize: "10.5pt",
                fontFamily: '"Arial", sans-serif',
        ...
        <p className="MsoNormal">
          <a href="http://127.0.0.1:5500/Website/policy.html#ip">
            <span
              style={{
                fontSize: "10.5pt",
                fontFamily: '"Arial", sans-serif',
        ...
        <p className="MsoNormal">
          <a href="http://127.0.0.1:5500/Website/policy.html#userreps">
            <span
              style={{
                fontSize: "10.5pt",
                fontFamily: '"Arial", sans-serif',
        ...
        <p className="MsoNormal">
          <a href="http://127.0.0.1:5500/Website/policy.html#userreg">
            <span
              style={{
                fontSize: "10.5pt",
                fontFamily: '"Arial", sans-serif',
        ...
        <p className="MsoNormal">
          <a href="http://127.0.0.1:5500/Website/policy.html#prohibited">
            <span
              style={{
                fontSize: "10.5pt",
                fontFamily: '"Arial", sans-serif',
        ...
        <p className="MsoNormal">
          <a href="http://127.0.0.1:5500/Website/policy.html#ugc">
            <span
              style={{
                fontSize: "10.5pt",
                fontFamily: '"Arial", sans-serif',
        ...
        <p className="MsoNormal">
          <a href="http://127.0.0.1:5500/Website/policy.html#license">
            <span
              style={{
                fontSize: "10.5pt",
                fontFamily: '"Arial", sans-serif',
        ...
        <p className="MsoNormal">
          <a href="http://127.0.0.1:5500/Website/policy.html#reviews">
            <span
              style={{
                fontSize: "10.5pt",
                fontFamily: '"Arial", sans-serif',
        ...
        <p className="MsoNormal">
          <a href="http://127.0.0.1:5500/Website/policy.html#mobile">
            <span
              style={{
                fontSize: "10.5pt",
                fontFamily: '"Arial", sans-serif',
        ...
        <p className="MsoNormal">
          <a href="http://127.0.0.1:5500/Website/policy.html#sitemanage">
            <span
              style={{
                fontSize: "10.5pt",
                fontFamily: '"Arial", sans-serif',
        ...
        <p className="MsoNormal">
          <a href="http://127.0.0.1:5500/Website/policy.html#ppyes">
            <span
              style={{
                fontSize: "10.5pt",
                fontFamily: '"Arial", sans-serif',
        ...
        <p className="MsoNormal">
          <a href="http://127.0.0.1:5500/Website/policy.html#copyrightyes">
            <span
              style={{
                fontSize: "10.5pt",
                fontFamily: '"Arial", sans-serif',
        ...
        <p className="MsoNormal">
          <a href="http://127.0.0.1:5500/Website/policy.html#modifications">
            <span
              style={{
                fontSize: "10.5pt",
                fontFamily: '"Arial", sans-serif',
        ...
        <p className="MsoNormal">
          <a href="http://127.0.0.1:5500/Website/policy.html#law">
            <span
              style={{
                fontSize: "10.5pt",
                fontFamily: '"Arial", sans-serif',
        ...
        <p className="MsoNormal">
          <a href="http://127.0.0.1:5500/Website/policy.html#disputes">
            <span
              style={{
                fontSize: "10.5pt",
                fontFamily: '"Arial", sans-serif',
        ...
        <p className="MsoNormal">
          <a href="http://127.0.0.1:5500/Website/policy.html#corrections">
            <span
              style={{
                fontSize: "10.5pt",
                fontFamily: '"Arial", sans-serif',
        ...
        <p className="MsoNormal">
          <a href="http://127.0.0.1:5500/Website/policy.html#disclaimer">
            <span
              style={{
                fontSize: "10.5pt",
                fontFamily: '"Arial", sans-serif',
        ...
        <p className="MsoNormal">
          <a href="http://127.0.0.1:5500/Website/policy.html#liability">
            <span
              style={{
                fontSize: "10.5pt",
                fontFamily: '"Arial", sans-serif',
        ...
        <p className="MsoNormal">
          <a href="http://127.0.0.1:5500/Website/policy.html#indemnification">
            <span
              style={{
                fontSize: "10.5pt",
                fontFamily: '"Arial", sans-serif',
        ...
        <p className="MsoNormal">
          <a href="http://127.0.0.1:5500/Website/policy.html#userdata">
            <span
              style={{
                fontSize: "10.5pt",
                fontFamily: '"Arial", sans-serif',
        ...
        <p className="MsoNormal">
          <a href="http://127.0.0.1:5500/Website/policy.html#electronic">
            <span
              style={{
                fontSize: "10.5pt",
                fontFamily: '"Arial", sans-serif',
        ...
        <p className="MsoNormal">
          <a href="http://127.0.0.1:5500/Website/policy.html#california">
            <span
              style={{
                fontSize: "10.5pt",
                fontFamily: '"Arial", sans-serif',
        ...
        <p className="MsoNormal">
          <a href="http://127.0.0.1:5500/Website/policy.html#misc">
            <span
              style={{
                fontSize: "10.5pt",
                fontFamily: '"Arial", sans-serif',
        ...
        <p className="MsoNormal">
          <a href="http://127.0.0.1:5500/Website/policy.html#contact">
            <span
              style={{
                fontSize: "10.5pt",
                fontFamily: '"Arial", sans-serif',
        ...
        <ul>
          <li className="MsoNormal" style={{ color: "white" }}>
            <span
              style={{ fontSize: "11.5pt", fontFamily: '"Arial", sans-serif' }}
            >
        ...
        <p className="MsoNormal">
          <b>
            ...
            >
              ...
              a&nbsp;license&nbsp;(including use of your name, trademarks, and
              logos):&nbsp;
            </span>
          </b>
          <span
        ...
        <p className="MsoNormal">
          ...
          >
            ...
            or&nbsp;unauthorized&nbsp;purpose; and (8) your use of the Services
        ...
        <ul>
          ...
          <li className="MsoNormal" style={{ color: "white" }}>
            ...
            <span
              style={{ fontSize: "10.5pt", fontFamily: '"Arial", sans-serif' }}
            >
              e Services as part of any effort to compete with us or otherwise
          ...
          <li className="MsoNormal" style={{ color: "white" }}>
            ...
            <span
              style={{ fontSize: "11pt", fontFamily: '"Arial", sans-serif' }}
            >
              ces to advertise or offer to sell goods and services.
            </span>
          </li>
          <li className="MsoNormal" style={{ color: "white" }}>
            <span
        ...
        <p className="MsoNormal" style={{ textAlign: "justify" }}>
          ...
          >
            ...
            such Contributions, and grant and&nbsp;authorize sublicenses&nbsp;of
        ...
        <p className="MsoNormal">
          ...
          >
            ...
            the Apple Store or Google Play (each an&nbsp;"App Distributor") to
            ...
            and conditions of this mobile application&nbsp;licensecontained in
            ...
            embargo, or that has been designated by the US government as
        ...
        <p className="MsoNormal">
          ...
          >
            ...
            advised the Services are hosted in&nbsp;Belgium. If you access the
            ...
            that differ from applicable laws in&nbsp;Belgium, then through your
            continued use of the Services, you are transferring your data
            to&nbsp;Belgium, and you expressly consent to have your data
            transferred to and processed in&nbsp;Belgium.&nbsp;Further, we do
        ...
        <p className="MsoNormal">
          ...
          >
            ...
            of&nbsp;Romania, and the use of the United Nations Convention of
            ...
            obligatory provisions of the law in your country to
            residence.&nbsp;Seen&nbsp;and yourself both agree to submit to the
            non-exclusive jurisdiction of the courts of&nbsp;Bucharest, which
            means that you may make a claim to defend your consumer protection
            rights in regards to these Legal Terms in&nbsp;Romania, or in the EU
        ...
        <p className="MsoNormal">
          ...
          >
            ...
            arbitration shall be&nbsp;Bucharest,&nbsp;Romania. The language of
            the proceedings shall be&nbsp;Romanina,English. Applicable rules of
            substantive law shall be the law of&nbsp;Romania.
          </span>
        </p>
        <p className="MsoNormal">
          <span
        ...
        <p className="MsoNormal">
          ...
          >
            ...
            or&nbsp;unauthorized&nbsp;use; and (c) any claim for injunctive
              ...
              <>
                ...
                <div className="WordSection1">
                  ...
                  <p className="MsoNormal">
                    <span
                      style={{
                        fontFamily: '"-webkit-standard", serif',
                        color: "white",
                      }}
                    >
                      &nbsp;
                  ...
                  <p className="MsoNormal">
                    ...
                    >
                      We provide a iOS application to allow users to share
                      moments and store them. The user facilitates the going
                      out's of people.
                    </span>
                  </p>
                  <p className="MsoNormal">
                  ...
                  <p className="MsoNormal">
                    ...
                    >
                      "), and&nbsp;Seen, concerning your access to and use of
                      the Services. You agree that by accessing the Services,
                      you have read, understood, and agreed to be bound by all
                      of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF
                  ...
                  <p className="MsoNormal">
                    ...
                    >
                      ...
                      changes to the Services you are using. Changes to Legal
                      Terms will become effective&nbsp;thirty (30)&nbsp;days
                      after the notice is given, except if the changes apply
                      to&nbsp;new functionality,&nbsp;security updates,&nbsp;bug
                      fixes, and&nbsp;a court order, in which case the changes
                      will be effective immediately. By continuing to use the
                      Services after the effective date of any changes, you
                      agree to be bound by the modified terms. If you disagree
                      with such changes, you may terminate Services as per the
                      section&nbsp;"
                    </span>
                    <a href="http://127.0.0.1:5500/Website/policy.html#terms">
                      <span
                  ...
                  <p className="MsoNormal">
                    ...
                    >
                      ...
                      Services (collectively, the&nbsp;"Content"), as well as
                  ...
                  <p className="MsoNormal">
                    ...
                    >
                      ...
                      broadcast content and materials to us or through the
                      Services, including but not limited to text, writings,
                      video, audio, photographs, music, graphics, comments,
                      reviews, rating suggestions, personal information, or
                  ...
                  <p className="MsoNormal">
                    <b>
                      ...
                      >
                        When you post Contributions, you grant us
                        a&nbsp;license&nbsp;(including use of your name,
                    ...
                    >
                      ...
                      or incorporate into other works, your Contributions, and
                      to&nbsp;sublicense the licenses&nbsp;granted in this
                  ...
                  <p className="MsoNormal">
                    ...
                    >
                      &nbsp;By sending us Submissions&nbsp;and/or posting
                      Contributions&nbsp;through any part of the
                      Services&nbsp;or making Contributions accessible through
                      the Services by linking your account through the Services
                  ...
                  <ul>
                    <li className="MsoNormal" style={{ color: "white" }}>
                      ...
                      >
                        ...
                        transmit through the Services any Submission&nbsp;nor
                        post any Contribution&nbsp;that is illegal, harassing,
                        hateful, harmful, defamatory, obscene, bullying,
                        abusive, discriminatory, threatening to any person or
                        group, sexually explicit, false, inaccurate, deceitful,
                        or misleading;
                      </span>
                    </li>
                    <li className="MsoNormal" style={{ color: "white" }}>
                    ...
                    <li className="MsoNormal" style={{ color: "white" }}>
                      ...
                      >
                        ...
                        the necessary rights and&nbsp;licenses&nbsp;to submit
                        such Submissions&nbsp;and/or Contributions&nbsp;and that
                  ...
                  <p className="MsoNormal">
                    ...
                    >
                      ...
                      Submissions&nbsp;and/or Contributions&nbsp;and you
                  ...
                  <p className="MsoNormal">
                    ...
                    >
                      ...
                      through a bot, script or otherwise; (7) you will not use
                      the Services for any illegal
                      or&nbsp;unauthorized&nbsp;purpose; and (8) your use of the
                  ...
                  <ul>
                    ...
                    <li className="MsoNormal" style={{ color: "white" }}>
                      ...
                      >
                        e Services as part of any effort to compete with us or
                  ...
                  <ul>
                    ...
                    >
                      ...
                      >
                        You are the creator and owner of or have the
                        necessary&nbsp;licenses, rights, consents, releases, and
                        permissions to use and to&nbsp;authorize&nbsp;us, the
                    ...
                    >
                      ...
                      >
                        ...
                        filthy, violent, harassing,&nbsp;libelous, slanderous,
                  ...
                  <p className="MsoNormal" style={{ textAlign: "justify" }}>
                    ...
                    >
                      ...
                      and&nbsp;license&nbsp;to host, use, copy, reproduce,
                  ...
                  <p className="MsoNormal" style={{ textAlign: "justify" }}>
                    ...
                    >
                      ...
                      technology now known or hereafter developed, and includes
                  ...
                  <p className="MsoNormal" style={{ textAlign: "justify" }}>
                    ...
                    >
                      ...
                      Contributions; (2) to&nbsp;re-categorize&nbsp;any
                  ...
                  <p className="MsoNormal">
                    ...
                    >
                      ...
                      not&nbsp;organize&nbsp;a campaign encouraging others to
                  ...
                  <p className="MsoNormal">
                    ...
                    >
                      ...
                      paid, assignable, and sublicensable right
                  ...
                  <p className="MsoNormal">
                    ...
                    >
                      ...
                      revenue-generating&nbsp;endeavor, commercial enterprise,
                      or other purpose for which it is not designed or intended;
                      (6) make the App available over a network or other
                      environment permitting access or use by multiple devices
                      or users at the same time; (7) use the App for creating a
                      product, service, or software that is, directly or
                      indirectly, competitive with or in any way a substitute
                      for the App; (8) use the App to send automated queries to
                      any website or to send any unsolicited commercial email;
                  ...
                  <p className="MsoNormal">
                    ...
                    >
                      ...
                      from either the Apple Store or Google Play (each
                      an&nbsp;"App Distributor") to access the Services: (1)
                      the&nbsp;license&nbsp;granted to you for our App is
                      limited to a non-transferable&nbsp;license&nbsp;to use the
                      application on a device that&nbsp;utilizes&nbsp;the Apple
                      ...
                      application&nbsp;licensecontained in these Legal Terms or
                      ...
                      with respect to the App; (3) in the event of any failure
                      of the App to conform to any applicable warranty, you may
                      ...
                      subject to a US government embargo, or that has been
                      ...
                      terms of agreement when using the App, e.g.,&nbsp;if you
                  ...
                  <p className="MsoNormal">
                    ...
                    >
                      ...
                      Terms. Please be advised the Services are hosted
                      in&nbsp;Belgium. If you access the Services from any other
                      region of the world with laws or other requirements
                      governing personal data collection, use, or disclosure
                      that differ from applicable laws in&nbsp;Belgium, then
                      through your continued use of the Services, you are
                      transferring your data to&nbsp;Belgium, and you expressly
                      consent to have your data transferred to and processed
                      in&nbsp;Belgium.&nbsp;Further, we do not knowingly accept,
                  ...
                  <p className="MsoNormal">
                    ...
                    >
                      ...
                      following the laws of&nbsp;Romania, and the use of the
                      ...
                      to residence.&nbsp;Seen&nbsp;and yourself both agree to
                      submit to the non-exclusive jurisdiction of the courts
                      of&nbsp;Bucharest, which means that you may make a claim
                      to defend your consumer protection rights in regards to
                      these Legal Terms in&nbsp;Romania, or in the EU country in
                      which you reside.
                    </span>
                  </p>
                  <p className="MsoNormal">
                  ...
                  <p className="MsoNormal">
                    ...
                    >
                      ...
                      acceptance. The seat of arbitration shall
                      be&nbsp;Bucharest,&nbsp;Romania. The language of the
                      proceedings shall be&nbsp;Romanina,English. Applicable
                      rules of substantive law shall be the law of&nbsp;Romania.
                    </span>
                  </p>
                  <p className="MsoNormal">
                    <span
                  ...
                  <p className="MsoNormal">
                    ...
                    >
                      ...
                      OF THE SERVICES, (3) ANY&nbsp;UNAUTHORIZED&nbsp;ACCESS TO
                      ...
                      MEDIUM OR IN ANY ENVIRONMENT, YOU SHOULD USE YOUR
                      BEST&nbsp;JUDGMENT&nbsp;AND EXERCISE CAUTION WHERE
                      APPROPRIATE.
                    </span>
                  </p>
                  <p className="MsoNormal">
                  ...
                  <p className="MsoNormal">
                    ...
                    >
                      ...
                      agree to cooperate, at your expense, with
                      our&nbsp;defense&nbsp;of such claims. We will use
