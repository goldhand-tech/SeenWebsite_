      ...
      <div>
        ...
        <div className="WordSection1">
          ...
          <p className="MsoNormal">
            ...
            >
              This privacy notice for&nbsp;Seen&nbsp;("<b>Company</b>," "
              <b>we</b>," "<b>us</b>," or "<b>our</b>"), describes how and why
              we might collect, store, use, and/or share ("<b>process</b>") your
          ...
          <ul>
            <li className="MsoNormal" style={{ color: "white" }}>
              ...
              >
                ...
                application&nbsp;(Seen),&nbsp;or any other application of ours
          ...
          <p className="MsoNormal">
            ...
            <span style={{ color: "white" }}>
              <a href="http://127.0.0.1:5500/Website/privacy.html#toc">
                <b>
                  <i>
                    <span
                      style={{
          ...
          <p className="MsoNormal">
            ...
            >
              ...
              with&nbsp;Seen&nbsp;and the Services, the choices you make, and
              the products and features you use. Learn more about&nbsp;
            </span>
            <span style={{ color: "white" }}>
              <a href="http://127.0.0.1:5500/Website/privacy.html#personalinfo">
                <span
                  style={{
                    fontSize: "10.5pt",
                    fontFamily: '"Arial", sans-serif',
          ...
          <p className="MsoNormal">
            ...
            <span style={{ color: "white" }}>
              <a href="http://127.0.0.1:5500/Website/privacy.html#infouse">
                <span
                  style={{
                    fontSize: "10.5pt",
                    fontFamily: '"Arial", sans-serif',
          ...
          <p className="MsoNormal">
            ...
            >
              ...
              specific&nbsp;categories of&nbsp;third parties. Learn more
              about&nbsp;
            </span>
            <span style={{ color: "white" }}>
              <a href="http://127.0.0.1:5500/Website/privacy.html#whoshare">
                <span
                  style={{
                    fontSize: "10.5pt",
                    fontFamily: '"Arial", sans-serif',
          ...
          <p className="MsoNormal">
            ...
            <span style={{ color: "white" }}>
              <a href="http://127.0.0.1:5500/Website/privacy.html#infosafe">
                <span
                  style={{
                    fontSize: "10.5pt",
                    fontFamily: '"Arial", sans-serif',
          ...
          <p className="MsoNormal">
            ...
            <span style={{ color: "white" }}>
              <a href="http://127.0.0.1:5500/Website/privacy.html#privacyrights">
                <span
                  style={{
                    fontSize: "10.5pt",
                    fontFamily: '"Arial", sans-serif',
          ...
          <p className="MsoNormal">
            ...
            <span style={{ color: "white" }}>
              <a
                href="https://app.termly.io/notify/eb34ce4b-7301-4b2c-a8b6-485f9cec0a10"
                target="_blank"
              >
                <span
                  style={{
          ...
          <p className="MsoNormal">
            ...
            >
              Want to learn more about what&nbsp;Seen&nbsp;does with any
          ...
          <p className="MsoNormal">
            <span style={{ color: "white" }}>
              <a href="http://127.0.0.1:5500/Website/privacy.html#infocollect">
                <span
                  style={{
                    fontSize: "10.5pt",
                    fontFamily: '"Arial", sans-serif',
          ...
          <p className="MsoNormal">
            <span style={{ color: "white" }}>
              <a href="http://127.0.0.1:5500/Website/privacy.html#legalbases">
                <span
                  style={{
                    fontSize: "10.5pt",
                    fontFamily: '"Arial", sans-serif',
          ...
          <p className="MsoNormal">
            <span style={{ color: "white" }}>
              <a href="http://127.0.0.1:5500/Website/privacy.html#cookies">
                <span
                  style={{
                    fontSize: "10.5pt",
                    fontFamily: '"Arial", sans-serif',
          ...
          <p className="MsoNormal">
            <span style={{ color: "white" }}>
              <a href="http://127.0.0.1:5500/Website/privacy.html#sociallogins">
                <span
                  style={{
                    fontSize: "10.5pt",
                    fontFamily: '"Arial", sans-serif',
          ...
          <p className="MsoNormal">
            <span style={{ color: "white" }}>
              <a href="http://127.0.0.1:5500/Website/privacy.html#inforetain">
                <span
                  style={{
                    fontSize: "10.5pt",
                    fontFamily: '"Arial", sans-serif',
          ...
          <p className="MsoNormal">
            <span style={{ color: "white" }}>
              <a href="http://127.0.0.1:5500/Website/privacy.html#DNT">
                <span
                  style={{
                    fontSize: "10.5pt",
                    fontFamily: '"Arial", sans-serif',
          ...
          <p className="MsoNormal">
            <span style={{ color: "white" }}>
              <a href="http://127.0.0.1:5500/Website/privacy.html#caresidents">
                <span
                  style={{
                    fontSize: "10.5pt",
                    fontFamily: '"Arial", sans-serif',
          ...
          <p className="MsoNormal">
            <span style={{ color: "white" }}>
              <a href="http://127.0.0.1:5500/Website/privacy.html#policyupdates">
                <span
                  style={{
                    fontSize: "10.5pt",
                    fontFamily: '"Arial", sans-serif',
          ...
          <p className="MsoNormal">
            <span style={{ color: "white" }}>
              <a href="http://127.0.0.1:5500/Website/privacy.html#contact">
                <span
                  style={{
                    fontSize: "11.5pt",
                    fontFamily: '"Arial", sans-serif',
          ...
          <p className="MsoNormal">
            <span style={{ color: "white" }}>
              <a href="http://127.0.0.1:5500/Website/privacy.html#request">
                <span
                  style={{
                    fontSize: "10.5pt",
                    fontFamily: '"Arial", sans-serif',
          ...
          <ul>
            <li className="MsoNormal" style={{ color: "white" }}>
              ...
              >
                ...
                device's&nbsp;camera,&nbsp;and other features. If you wish to
                change our access or permissions, you may do so in your device's
                settings.
              </span>
            </li>
          ...
          <p className="MsoNormal">
            ...
            <i>
              ...
              >
                ...
                or&nbsp;fulfill&nbsp;our contractual obligations, to protect
                your rights, or to&nbsp;fulfill&nbsp;our legitimate business
                interests.
              </span>
            </i>
          </p>
          ...
          <ul>
            <li className="MsoNormal" style={{ color: "white" }}>
              ...
              <a href="http://127.0.0.1:5500/Website/privacy.html#withdrawconsent">
                <span
                  style={{
                    fontSize: "10.5pt",
                    fontFamily: '"Arial", sans-serif',
          ...
          <ul>
            <li className="MsoNormal" style={{ color: "white" }}>
              ...
              >
                ...
                to you, including providing our Services or at your request
          ...
          <p className="MsoNormal">
            ...
            <i>
              ...
              >
                ...
                in this section and/or with the following&nbsp;categories
                of&nbsp;third parties.
              </span>
            </i>
          </p>
          ...
          <p className="MsoNormal">
            ...
            >
              ...
              They will also not share your personal information with
              any&nbsp;organization&nbsp;apart from us. They also commit to
          ...
          <p className="MsoNormal">
            ...
            >
              ...
              longer than&nbsp;twelve (12)&nbsp;months past the termination of
              the user's account.
            </span>
          </p>
          <p className="MsoNormal">
